...
## Title
Interactive Question Interface for Published Articles

## Backlog ID
0036

## Priority
- **P1 (proposed)**: decomposed from legacy `ROADMAP.md` (Phase 1: Stabilization & Core Improvements (Q1-Q2 2025), High Priority). Requires review before promotion to `planned/`.

## Date / Time
2026-01-31 (decomposed from legacy roadmap; needs re-estimation)

## Short Summary
This backlog item was decomposed from legacy `ROADMAP.md` section **1.4**. The legacy roadmap is archived at [`docs/backlog/completed/0032_legacy_roadmap.md`](../completed/0032_legacy_roadmap.md).
...
## Full Report (legacy ROADMAP extract: 1.4)
