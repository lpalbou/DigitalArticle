...
## Date / Time
2025-11-21 (historical; migrated 2026-01-31)

## Short Summary
This file preserves a historical devnote that previously lived under `docs/backlog/completed/0012_fix_traces_after_docker.md`. It has been migrated to `docs/backlog/completed/` so that historical investigations and fixes live under the same backlog governance system.
...
- Legacy source: `docs/backlog/completed/0012_fix_traces_after_docker.md` (removed after migration)
...
> **Devnote (historical):** This document records a past tracing mismatch issue. For current tracing behavior, see `backend/app/services/llm_service.py` (enable_tracing) and `CHANGELOG.md` entries around `0.3.13`.
