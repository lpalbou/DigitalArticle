...
## Short Summary
This file preserves a historical devnote that previously lived under `docs/backlog/completed/0015_abstractcore_v262_upgrade.md`. It has been migrated to `docs/backlog/completed/` so that historical investigations and fixes live under the same backlog governance system.
...
- Legacy source: `docs/backlog/completed/0015_abstractcore_v262_upgrade.md` (removed after migration)
...
> **Devnote (historical):** This document tracks an AbstractCore upgrade effort. For current provider discovery + configuration behavior, see `backend/app/api/llm.py` and `backend/app/services/user_settings_service.py`.
...
### Documentation
- `docs/backlog/completed/0015_abstractcore_v262_upgrade.md` (this file)
- Updated: `docs/backlog/completed/0022_model_download_implementation_final.md` (reference)
...
- **Previous Implementation**: `docs/backlog/completed/0022_model_download_implementation_final.md`
