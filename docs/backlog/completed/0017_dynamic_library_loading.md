...
## Short Summary
This file preserves a historical devnote that previously lived under `docs/backlog/completed/0017_dynamic_library_loading.md`. It has been migrated to `docs/backlog/completed/` so that historical investigations and fixes live under the same backlog governance system.
...
- Legacy source: `docs/backlog/completed/0017_dynamic_library_loading.md` (removed after migration)
...
> **Devnote (historical / proposal):** This document proposes a future enhancement and may not reflect current implementation. For current execution/library behavior, start at `docs/dive_ins/execution_service.md`.
