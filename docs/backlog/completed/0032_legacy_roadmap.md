# Backlog Item (Historical; archived legacy roadmap)

## Title
Legacy roadmap archive (superseded by docs-native backlog)

## Backlog ID
0032

## Priority
- **P2 (historical)**: preserves the old roadmap content as context while the backlog becomes the canonical planning system.

## Date / Time
2025-01 (historical; archived 2026-01-31)

## Short Summary
This file archives the previous `ROADMAP.md` (last updated Jan 2025) as a historical record. The canonical planning system is now `docs/backlog/`.

## Key Goals
- Preserve legacy roadmap content without letting it drift as “truth”.
- Point contributors to the backlog/ADR governance system.

## Scope

### To do
- Preserve the legacy roadmap under **Full Report**.
- Replace `ROADMAP.md` with a short pointer to the backlog.

### NOT to do
- Do not treat this archived roadmap as canonical.
...
- Avoid duplicating backlog items; roadmap epics should be reviewed and promoted through `proposed/` → `planned/`.

## References (source of truth)
- Canonical backlog: [`docs/backlog/README.md`](../README.md)
- ADR index: [`docs/adr/README.md`](../../adr/README.md)

## Full Report (legacy ROADMAP.md content)
